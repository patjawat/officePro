...
<body class="hold-transition sidebar-mini sidebar-collapse">
    ...
    <div class="wrapper">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                        <a href="#" class="dropdown-item">
                            <!-- Message Start -->
                            <div class="media">
                                <?=Html::img('@web/adminlte3/dist/img/user1-128x128.jpg',['class' => 'img-size-50 mr-3 img-circle'])?>
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            <!-- Brand Logo -->
            <?=Html::a(Html::img('@web/adminlte3/dist/img/AdminLTELogo.png',['class' =>'brand-image img-circle elevation-3']).' <span class="brand-text font-weight-light">AdminLTE 3</span>',null, ['class' =>'brand-link'])?>
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        <?=Html::img('@web/adminlte3/dist/img/user1-128x128.jpg',['class' => 'img-circle elevation-2'])?>
