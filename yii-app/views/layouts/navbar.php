    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse order-3" id="navbarCollapse">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <?=Html::a('ห้องประชุม', ['/mr/meeting-room'], ['class' => 'nav-link']);?>
                </li>
        ...
        <ul class="order-1 order-md-3 navbar-nav navbar-no-expand ml-auto">
            ...
            <li class="nav-item">
                ...
                <?=Html::a('<i class="fas fa-fingerprint"></i> ' . Yii::$app->user->identity->username, ['/site/logout'], [
    'data' => [
        'confirm' => 'ออกจากระบบ',
        'method' => 'post',
    ],
    'class' => 'nav-link', 'style' => 'font-size: 23px;font-weight: 200;'])?>
                <?php endif;?>
            </li>
        </ul>
    </div>
