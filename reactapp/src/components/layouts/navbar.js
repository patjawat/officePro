...
function Navbar() {
  ...
  <ul className="navbar-nav">
    ...
    <li className="nav-item d-none d-sm-inline-block">
      <a href="<?=\yii\helpers\Url::home()?>" className="nav-link loading-page">หน้าหลัก</a>
    </li>
  ...
  <ul className="navbar-nav ml-auto">
    ...
    <li className="nav-item dropdown">
      ...
      <div className="dropdown-menu dropdown-menu-lg dropdown-menu-right">
        <a href="#" className="dropdown-item">
          {/* Message Start */}
          <div className="media">
            <img src="<?=$assetDir?>/img/user1-128x128.jpg" alt="User Avatar" className="img-size-50 mr-3 img-circle" />
    ...
    <li className="nav-item dropdown user-menu">
      <a href="#" className="nav-link dropdown-toggle" data-toggle="dropdown">
        <img src={user} className="user-image img-circle elevation-2" alt="User Image" />
      ...
      <ul className="dropdown-menu dropdown-menu-lg dropdown-menu-right">
        ...
        <li class="user-footer">
                    ...
                    <a class="btn btn-default btn-flat float-right" href="" onClick={logout}>Sign out</a></li>
      </ul>
    </li>
    <li className="nav-item">
